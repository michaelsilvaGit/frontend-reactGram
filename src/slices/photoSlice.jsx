...
//Publis user photo
export const publisPhoto = createAsyncThunk(
    "photo/publish",
...
export const photoSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
        .addCase(publisPhoto.pending, (state) => {
            state.loading = true;
            state.error = false;
        })
        .addCase(publisPhoto.fulfilled, (state, action) => {
            state.loading = false;
            state.sucess = true;
            state.error = null;
        ...
        .addCase(publisPhoto.rejected, (state, action) => {
            state.loading = false;
